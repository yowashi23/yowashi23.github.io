    ...
    return <section className="portfolio--section" id="MyPortfolio">
        <div className="portfolio--container-box">
            ...
            <div>
                ...
                <button className="btn btn-primary" onClick={() => window.open("https://github.com/yowashi23")}>GitHub</button>
            </div>
        </div>
        <div className="portfolio--section--container">
            {data?.portfolio?.map((item, index) => (
                <div key={index} className="portfolio--section--card" onClick={() => window.open(item.link)}>
