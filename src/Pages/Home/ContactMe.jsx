    ...
    return (
        <section id="Contact" className="contact--section">
            <div>
                ...
                <h2>Contact Me</h2>
                <p className="text-lg">Feel free to just email me at shin.yongwhan23@gmail.com if you want!</p>
            </div>
            <form className="contact--form--container" action="https://formspree.io/f/xdoqvewd" method="post">
                <div className="container">
                    ...
                    <label htmlFor="email" className="contact--label">
                        ...
                        <input type="text" className="contact--input text-md" name="email" id="email" required></input>
                    </label>
                    <label htmlFor="phone-number" className="contact--label">
                        <span className="text-md">Phone Number</span>
                        <input type="text" className="contact--input text-md" name="phone-number" id="phone-number"></input>
                    </label>
                </div>
