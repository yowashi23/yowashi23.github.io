        ...
        <nav className={`navbar ${navActive? "active" : ""}`}>
            ...
            <div className={`navbar--items ${navActive ? "active" : ""}`}>
                <ul>
                    ...
                    <li>
                        {/* <Link onClick={closeMenu} activeClass="navbar--active-content" spy={true} smooth={true} offset={-70} duration={500} to="AboutMe" className="navbar--content">Music</Link> */}
                    </li>
                    <li>
                        {/* <Link onClick={closeMenu} activeClass="navbar--active-content" spy={true} smooth={true} offset={-70} duration={500} to="Guitar" className="navbar--content">Sports</Link> */}
                    </li>
                </ul>
            </div>
