  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/yongwshin/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Inspired by <a href="https://www.youtube.com/@howtobecomeadeveloper">@howtobecomeadeveloper</a></p>
        <div className="footer--social--icon">
          <ul>
            {/* <li>
              <Link
